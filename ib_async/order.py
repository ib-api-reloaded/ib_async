...
class OrderState:
    ...
    minCommission: float = nan
    maxCommission: float = nan
    commissionCurrency: str = ""
    marginCurrency: str = ""
    initMarginBeforeOutsideRTH: float = nan
    maintMarginBeforeOutsideRTH: float = nan
    equityWithLoanBeforeOutsideRTH: float = nan
    initMarginChangeOutsideRTH: float = nan
    maintMarginChangeOutsideRTH: float = nan
    equityWithLoanChangeOutsideRTH: float = nan
    initMarginAfterOutsideRTH: float = nan
    maintMarginAfterOutsideRTH: float = nan
    equityWithLoanAfterOutsideRTH: float = nan
